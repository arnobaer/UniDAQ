...
class Main_window:
    ...
    def __init__(self, GUI, layout):
        ...
        dynamic = QWidget()
        self.dynamic = self.variables.load_QtUi_file("./modules/QT_Designer_UI/Main.ui", dynamic)
    ...
    def plot_config(self):
        ...
        self.dynamic.plot.setTitle("Dynamic IV waiting time analysis")
        self.dynamic.plot.setLabel('left', "current", units='A')
        self.dynamic.plot.setLabel('bottom', "voltage", units='V')
        self.dynamic.plot.showAxis('top', show=True)
        self.dynamic.plot.showAxis('right', show=True)
        self.dynamic.plot.plotItem.showGrid(x=True, y=True)
